package fr.celyanrbx.lolomobs.worldgen.tree;

import fr.celyanrbx.lolomobs.LoloMobs;
import fr.celyanrbx.lolomobs.worldgen.tree.custom.PineTrunkPlacer;
...
public class ModTrunkPlacerTypes {
    public static final DeferredRegister<TrunkPlacerType<?>> TRUNK_PLACER =
            DeferredRegister.create(Registries.TRUNK_PLACER_TYPE, LoloMobs.MOD_ID);
