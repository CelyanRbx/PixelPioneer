...
public class ModBiomes {
    public static final ResourceKey<Biome> EMERALD_FOREST_BIOME = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(PixelPioneer.MOD_ID, "emerald_forest_biome"));

    public static void boostrap(BootstapContext<Biome> context) {
        context.register(EMERALD_FOREST_BIOME, testBiome(context));
    }
